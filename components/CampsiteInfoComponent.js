...
const mapStateToProps = ({ campsites, comments, favorites }) =>       // connecting the Redux Store's state to our props. Only connecting the state portion we need                                               which is campsites and comments
    ({
        campsites,
        comments,
        favorites
